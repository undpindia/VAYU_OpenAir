...
//   useEffect(() => {
//     if (formValues.device_type === 'dynamic' && formValues.device_id !== 'all') {
//       setFormValues((prevValues) => ({
//         ...prevValues,
//         device_id: 'all',
//       }));
...
//           <DialogContent className="w-full max-w-[800px] h-[600px] sm:h-auto sm:w-full sm:max-h-full p-6">
//             <div className="w-full flex flex-col justify-center items-start">
//               <h1 className="font-semibold text-black text-[20px] leading-[28px] mb-4 text-justify">
...
//                 leveraging citizen scientists and IoT-based low-cost sensors to
//                 collect hyperlocal air quality data. This data is used to
//                 identify pollution sources and risk zones, facilitating targeted
...
//               <span className="text-[20px] leading-[26px] font-semibold mb-3 text-justify">
//                 Select the city to view data
//               </span>

//               <div className="flex justify-between items-center w-full gap-4 mt-4">
//                 <Button
//                   variant="outline"
//                   className="w-1/2 rounded-none h-[50px] text-[18px] "
//                   onClick={() => {
