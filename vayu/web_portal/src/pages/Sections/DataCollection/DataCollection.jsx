    ...
    <div className="relative top-[5%] w-full flex justify-center items-start flex-col">
      ...
      <span className="font-normal text-[20px] p-[20px] md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] leading-[28.16px] md:p-2 lg:p-[20px] text-justify">
        ...
        <ul className="list-disc pl-5 mt-2">
          <li className="font-normal text-[18px] leading-[28.16px] md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] text-justify">
      ...
      <span className="font-normal text-[20px] p-[20px] md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] leading-[28.16px] md:p-2 lg:p-[20px] text-justify">
        ...
        <ul className="list-disc pl-5 mt-2">
          <li className="font-normal text-[18px] leading-[28.16px] md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] text-justify">
            Establish data pipelines and automated data modeling to create
            India&#39;s first real-time digital stack on emissions, covering all
            emission sources in targeted cities.
          </li>
        </ul>
      </span>

      {/* <div className="font-normal text-[20px] p-[20px] md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] leading-[28.16px] md:p-2 lg:p-[20px] text-justify">
