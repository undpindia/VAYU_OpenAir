const Feedback = () => {
  return (
    <div className="w-full flex flex-col items-start p-4 space-y-6">
      <span className="font-normal text-[20px] sm:p-0 md:text-[14px] md:leading-[20px]  lg:text-[24px] lg:leading-[28.16px] leading-[28.16px] md:p-2 lg:p-[20px] lg:text-left md:text-left sm:text-left">
